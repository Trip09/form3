    ...
    <div className="welcome">
        ...
        <section className="welcome__main">
            ...
            <div className="main__content">
                <h1>
                    Welcome to - Form3 Exercice <br/> <small>build with <strong>API Platform</strong></small>!
                </h1>
                <div className="main__other">
                    ...
                    <div className="other__bloc">
                        ...
                        <div className="other__content">
                            <h3>OpenApi  - YAML - Generate Any Client</h3>
                            <ButtonsGroup
                                httpLink="http://localhost:8080/openapi.yaml"
                                httpsLink="https://localhost:8443/openapi.yaml"
                            />
                            <h3>PostmanFiles - Working Requests</h3>
                            <ButtonsGroup
                                httpLink="http://localhost:8080/Form3.postman_collection.json"
                                httpsLink="https://localhost:8443/Form3.postman_collection.json"
                            />
                        </div>
                    </div>
                </div>
